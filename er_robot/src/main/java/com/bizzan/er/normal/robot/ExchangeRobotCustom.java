...
public class ExchangeRobotCustom implements Runnable, ExchangeRobot{
	...
	protected String currenOrderURL = "http://103.218.242.25:8801/exchange/order/mockcurrentydhdnskd";
	protected String cancelOrderURL = "http://103.218.242.25:8801/exchange/order/mockcancelydhdnskd";
	protected String exchangeTYPE = "LIMIT_PRICE";
	protected String directionSELL = "SELL";
	protected String commitOrderURL = "http://103.218.242.25:8801/exchange/order/mockaddydhdnskd";
	protected String plateURL = "http://103.218.242.25:8801/market/exchange-plate-mini";
	...
	public ExchangeRobotCustom(String host, String sign){
		this.currenOrderURL = "http://" + host + ":8801/exchange/order/mockcurrentydhdnskd";
		this.cancelOrderURL = "http://" + host + ":8801/exchange/order/mockcancelydhdnskd";
		this.commitOrderURL = "http://" + host + ":8801/exchange/order/mockaddydhdnskd";
		this.plateURL = "http://" + host + ":8801/market/exchange-plate-mini";
		this.sign = sign;
	}
